...
```{r}
#we add a column with this total number to the dataframe yt_words
#we use left join because we need the join to keep all rows in yt_words, regardless of repeating rows
words <- yt_words %>%
...
#we calculate the distribution and put it in the x axis, filling by user
