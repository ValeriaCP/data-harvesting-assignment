...
# unnesting the word
word = link_comments |> unnest_tokens(word, response_list.data.children.data.body)
print(word)
```
...
trump = rbind(trump_positive, trump_negative, trump_anger, trump_trust)
print(trump)

# erase the word "vote" since it is neutral and duplicated a lot
trump = trump |> filter(word != "vote")
print(trump)
```
